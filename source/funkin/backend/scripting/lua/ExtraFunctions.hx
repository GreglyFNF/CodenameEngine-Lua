	...
	public static function implement(funk:CodenameLua)
	{
		...
		Lua_helper.add_callback(lua, "keyJustPressed", function(name:String = '') {
			...
			switch(name) {
				...
				default: return PlayState.instance.controls.getJustPressed(name);
			}
			return false;
		});
		Lua_helper.add_callback(lua, "keyPressed", function(name:String = '') {
			...
			switch(name) {
				...
				default: return PlayState.instance.controls.getPressed(name);
			}
			return false;
		});
		Lua_helper.add_callback(lua, "keyReleased", function(name:String = '') {
			...
			switch(name) {
				...
				default: return PlayState.instance.controls.getJustReleased(name);
			}
			return false;
		});
