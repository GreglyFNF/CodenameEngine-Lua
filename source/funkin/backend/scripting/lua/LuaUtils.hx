...
class LuaUtils
{
	...
	{
		return ((PlayState.instance.health <= 0 && PlayState.instance.canDie) || (PlayState.instance.health >= PlayState.instance.maxHealth && PlayState.instance.canDadDie)) ? GameOverSubstate.instance : PlayState.instance;
	}
